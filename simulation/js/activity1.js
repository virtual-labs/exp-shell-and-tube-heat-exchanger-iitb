...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(tank, new Chemistry.Point(500, 200), 382, 287, canvas);
    sq.name = 'tank';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(pump, new Chemistry.Point(1450, 170), 207, 146, canvas);
    sq.name = 'pump';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(heater, new Chemistry.Point(1150, 400), 204, 40, canvas);
    sq.name = 'heater';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(temp_controller, new Chemistry.Point(1150, 700), 207, 204, canvas);
    sq.name = 'temp_controller';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(temp_indi_blue, new Chemistry.Point(475, 550), 93, 93, canvas);
    sq.name = 't_in';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(heat_exchanger, new Chemistry.Point(1700, 500), 320, 419, canvas);
    sq.name = 'heat_exchanger';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(pipe_h_img, new Chemistry.Point(230, 800), 351, 63, canvas);
    sq.name = 'pipe_h';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(pipe_v_img, new Chemistry.Point(185, 500), 50, 195, canvas);
    sq.name = 'pipe_v';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(glass_sec, new Chemistry.Point(800, 600), 71, 215, canvas);
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 4,
        question: "Select <span style='color: #018fc3'> Shell and Tube Heat Exchanger </span>",
        ans: 'heat_exchanger',
        hint: [
            'Double Pipe',
            'pipe inside a pipe',
...
function load_higlighted_images() {
    ...
    a1_labels = [
        ...
        new Chemistry.Text('Temp Controller', new Chemistry.Point(1030, 640), canvas),
        new Chemistry.Text('Temp Indicator', new Chemistry.Point(400, 445), canvas),
        new Chemistry.Text('Shell and Tube Heat Exchanger', new Chemistry.Point(1500, 730), canvas),
        new Chemistry.Text('Horizontal Pipe', new Chemistry.Point(145, 745), canvas),
        new Chemistry.Text('Vertical Pipe', new Chemistry.Point(35, 470), canvas),
        new Chemistry.Text('Glass Section', new Chemistry.Point(600, 600), canvas),
    ];
}
