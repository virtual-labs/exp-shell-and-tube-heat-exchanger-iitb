...
function activity7() {
    ...
    pp.addoffcanvas(3);
    pp.addoffcanvas(4);
    pp.showtitle('<p style="background-color: #A8A196; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 1.2vw; width:100%; text-align:center;">Calculate data for table</p>', 3);
    let label3 = document.getElementById('offcanvasRightLabel3');
    label3.style.width = '20vw';
    pp.showdescription(`<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 1.2vw;"><b> Constants</b> <br><br>
   &rho; = 0.835 gm/cc <br>
   cp = 2.71 J/gm-k <br>
   k = 0.127 w/m-k <br>
   &mu; = 2.941 cp <br>
   ...
   b<sub>val</sub> = 0.5710080628 <br>
    ...
    pp.showtitle('<p style="background-color: #A8A196; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 1.2vw; width:100%; text-align:center;">Formula for calculation</p>', 4);
    let label4 = document.getElementById('offcanvasRightLabel4');
    label4.style.width = '20vw';
    pp.showdescription(`<p>
...
function load_table() {
    ...
    data_1[0].push(`<input type='text' class='form-control' id='v-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='m-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='u-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='lmtd-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='q-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='ui-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='lnui-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='text' class='form-control' id='lnm-inp' style='width: 100%' />`);
    data_1[0].push(`<input type='button' class='btn btn-primary' id='verify-1-btn' style='width: 100%' onclick='verify_table_1();' value='Verify' />`);
    //load data for second table
    data_2[0].push('1');
    data_2[0].push(shell_table['t'][0]);
    data_2[0].push(`<input type='text' class='form-control' id='m453-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='m1-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='re-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='pr-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='ui1-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='ho1-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='hi1-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='hi_exp-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='text' class='form-control' id='hi_theo-inp' style='width: 100%' />`);
    data_2[0].push(`<input type='button' class='btn btn-primary' id='verify-2-btn' style='width: 100%' onclick='verify_table_2();' value='Verify' />`);
...
function load_table_data() {
    ...
    pp.addtoleftpannel(table.template);
    table.draw();
    pp.addtorightpannel(`<button id="panel2_btn" class="btn btn-primary" onclick="activity8()" style="position: absolute; font-size:1.1vw; left:2.5vh; bottom: 12vh;  width: 90%;">Next</button>`, 3);
    // show_right_pannel(3);
}
...
function verify_table_2() {
    ...
    let val1 = (document.getElementById('m453-inp'));
    let val2 = (document.getElementById('m1-inp'));
    let val3 = (document.getElementById('re-inp'));
    let val4 = (document.getElementById('pr-inp'));
    let val5 = (document.getElementById('ui1-inp'));
    let val6 = (document.getElementById('ho1-inp'));
    let val7 = (document.getElementById('hi1-inp'));
